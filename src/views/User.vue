...
const rules = reactive({
  ...
  birth: [{ required: true, message: "出生日期是必选项", trigger: "blur" }],
...
<template>
  <div class="user-header">
    ...
    <el-form :inline="true" :model="formInline">
      <el-form-item label="请输入">
        <el-input placeholder="请输入用户姓名" v-model="formInline.keyWord" :prefix-icon="Search" clearable
          @clear="getUserData"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <el-dialog v-model="dialogVisible" :title="action === 'add' ? '新增用户' : '编辑用户'" width="35%" :before-close="handleClose"
    ...
    <!-- 需要注意的是设置了:inline="true",
     会对 el-select 的样式造成影响，
     我们通过给它设置一个 class="select-clearn" 
     在 css 进行处理-->
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="select-clearn" label="性别" prop="sex">
            <el-select v-model="formUser.sex" placeholder="请选择" style="width: 80px">
